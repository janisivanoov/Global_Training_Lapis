...
class Globaltraining_Core_Lapis{
     ...
     */
    public function lead_ninja_to_lapis($form_data){
        $fields = $form_data['fields'];

        $gt_lead_first_name = null;
        $gt_lead_last_name = null;
        $gt_lead_gender = "O";
        $gt_lead_countryname = null;
        $gt_lead_email = null;
        $gt_lead_phone = null;
        $gt_lead_program = null;
        $gt_lead_location = null;
        $gt_lead_utmSource = null;
        $gt_lead_utmMedium = null;
        $gt_lead_utmTerm = null;
        $gt_lead_utmContent = null;
        $gt_lead_utmCampaign = "Direct";

        foreach( $fields as $field ) { // Field settigns, including the field key and value.
        ...
        try{
            ...
            $stmt = $conn->prepare('EXECUTE [Phoenix].[Web].[AddLeadStudent]
                :firstName,
                :lastName,
                :gender,
                :country,
            ...
            if($stmt->execute($lead_data)){
                    $body = $gt_lead_first_name.' '.$gt_lead_last_name. '
                    <p>Student data synced to LAPIS. Data Synced:</p>
                    <ul>
                        <li>First Name: '.$lead_data['firstName'].'</li>
                        <li>Last Name: '.$lead_data['lastName'].'</li>
                        <li>Country: '.$lead_data['country'].'</li>
                        <li>Email: '.$lead_data['email'].'</li>
                        <li>Phone: '.$lead_data['phone'].'</li>
                        <li>Address: '.$lead_data['address'].'</li>
                        <li>Birthday: '.$lead_data['birthday'].'</li>
                        <li>Qualification: '.$lead_data['qualificationName'].'</li>
                        <li>Additional Info: '.$lead_data['additionalInfo'].'</li>
                        <li>UTM-Source: '.$lead_data['utmSource'].'</li>
                        <li>UTM-Medium: '.$lead_data['utmMedium'].'</li>
                        <li>UTM-Term: '.$lead_data['utmTerm'].'</li>
                        <li>UTM-Content: '.$lead_data['utmContent'].'</li>
                        <li>UTM-Campaign: '.$lead_data['utmCampaign'].'</li>
                        <li>Form Type: Apply </li>
                    </ul>
                    </br>
                ';
     ...
     */
    private function exelixis_sync($order_id, $gender, $sku, $user_id){
        /**
        * START OF EXELIXIs
        */
         //Exelixis Server
